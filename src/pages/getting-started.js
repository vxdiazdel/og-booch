...
const GettingStarted = ({ data }) => (
  <Layout>
    ...
    <Wrapper className="mt-5">
      <h1>What You Need</h1>
      <ul>
        <li>One gallon glass brewing jar</li>
      ...
      <ul>
        ...
        <li>Let your mixture cool. It should be between 68-86&deg; F before moving on to the next step.</li>
        <li>Add your SCOBY and starter tea to your freshly brewed tea mixture. The SCOBY may sink or float to the top now or sime time during the fermentation process. Either way, don't be worried, it is OK and will not affect your brew.</li>
        <li>Stir your solution once and test the acidity with a PH strip. The strip should read 4.5 or below. If it does not, you can add 1 Tbsp of white vinegar and retest until it reaches 4.5 or below.</li>
        <li>Cover and secure the jar with the cheese cloth and rubber band.</li>
        <li>All the mixture to sit at room temperature for 7-12 days out of direct sunlight but in an area with adequate air flow.</li>
      </ul>
      <p>
        Kombucha brews best between 68-78&deg; F. Kombucha will not ferment properly in colder temperatures and will likely grow mold. Between the 7-12 day period you should see a new cream-colored layer forming on the top of your jar, which is the new SCOBY forming. Remove the cloth cover and use a spoon to taste your liquid Kombucha mixture. If it is sweeter than your desired taste you and replace the cloth cover and let it ferment longer.
      </p>
      <p><strong>Congratulations! If everything went well your kombucha is now ready for consumption. 🙃</strong></p>
      <p>Your kombucha can be enjoyed plain or can be flavored during the bottling process (also known as 2nd Fermentation).</p>
      <h2>What to Do Next</h2>
      <p>Remove the SCOBY from your gallong jar together with 1-2 cups of your finished kombucha. Set this aside in another jar or container as this will be your new SCOBY and starter tea for future batches okf Kombucha brewing.</p>
      <p>When you are ready to brew again, simply follow the instructions from the start using or both of the SCOBYs. SCOBYs can usually be used and reused up to 5 or 6 times.</p>
      <p>For every one gallon batch of Kombucha you brew, use 1 cup of refined white sugar and 6-8 caffeinated tea bags (or 3-4 Tbsp of caffeinated loose leaf tea). Any tea such as black, green or oolong will suffice and will yiled slightly different flavors. Herbal teas are NOT recommended for Kombucha and sugar substitutes are not effective for fermentation as they are too complex for the culture to break down.</p>
